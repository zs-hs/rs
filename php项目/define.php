...
if(isset($_GET['id'])){
	$id=$_GET['id'];
	$select1=$conn->query("select * from tb_book where id='$id'");	
	$array1=mysqli_fetch_array($select1);
}
...
setInterval("labtime.innerText=new Date().toLocaleString()",1000)
  ...
  <tr>
   <td width="800" height="430" valign="top" align="center" bgcolor="#DCC874" background="images/6.jpg">
	          <form id="form2" name="form2" method="post" action="">
      <table width="678" height="40" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#CC9900" ><caption>图书详细信息</caption>

      <tr>
        <td height="5" align="right"><div align="right">书名：</div></td>
        <td align="left">&nbsp;<?php echo $array1['books'];?></td>
      </tr>
      <tr>
        <td width="109" height="5" align="right"><div align="right">上传日期：</div></td>
        <td width="443" align="left">&nbsp;<?php echo $array1['date'];?></td>
      </tr>
      <tr>
        <td height="5" align="right"><div align="right">类别：</div></td>
        <td align="left">&nbsp;<?php echo $array1['sort'];?></td>
      </tr>
      <tr>
        <td height="5" align="right"><div align="right">语言：</div></td>
        <td align="left">&nbsp;<?php echo $array1['talk'];?></td>
      </tr>
      <tr>
        <td height="5" align="right"><div align="right">文稿存储位置：</div></td>
        <td align="left">&nbsp;<a target="_blank" href="<?php echo $array1['bookpath'];?>"><?php echo $array1['bookpath'];?></a></td>
      </tr>
      <tr>
        <td height="5" align="right"><div align="right">程序存储位置：</div></td>
        <td align="left">&nbsp;<a target="_blank" href="<?php echo $array1['programpath'];?>"><?php echo $array1['programpath'];?></a></td>
      </tr>
      <tr>
        <td height="5" align="right"><div align="right">录像存储信置：</div></td>
        <td align="left">&nbsp;<a target="_blank" href="<?php echo $array1['videopath'];?>"><?php echo $array1['videopath'];?></a></td>
      </tr>
      <tr>
        <td height="37" align="right"><div align="right">简介：</div></td>
        <td align="center" valign="middle">&nbsp;
          <textarea name="textarea2" cols="65" rows="3"><?php echo $array1['sysnopsis'];?></textarea></td>
      </tr>
      <tr>
        <td height="60" align="right"><div align="right">目录：</div></td>
        <td align="center" valign="middle">&nbsp;
