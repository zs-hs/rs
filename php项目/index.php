...
$select1=$conn->query("select * from tb_book where talk='PHP' order by id DESC limit 2");		//查询PHP类最新图书信息
$select2=$conn->query("select * from tb_book where talk='C' order by id DESC limit 2");		//查询cc++类最新图书信息
$select3=$conn->query("select * from tb_book where talk='.net' order by id DESC limit 2");		//查询net类最新图书信息
$select4=$conn->query("select * from tb_book where talk='JAVA' order by id DESC limit 2");		//查询java类最新图书信息
$select5=$conn->query("select * from tb_book where talk='VB' order by id DESC limit 2");		//查询vb类最新图书信息
$select6=$conn->query("select * from tb_book where talk='other' order by id DESC limit 2");		//查询其它类最新图书信息
...
setInterval("labtime.innerText=new Date().toLocaleString()",1000)
  ...
  <tr>
    <td width="800" height="430" valign="top" align="center" bgcolor="#DCC874" background="images/6.jpg"><table border="1" width="627" height="400" border="0" align="center" cellpadding="0" cellspacing="0"><caption>最新图书信息</caption>

      <tr>
        <td height="100" align="center" valign="baseline"><table width="281" height="44" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td height="19" colspan="2"><div align="center" class="STYLE3">PHP</div></td>
            </tr>
		<?php
		while($array1=mysqli_fetch_array($select1)){			//循环输出图书信息
		$talk1=$array1['talk'];				//定义变量，获取图书语言
		?>
          <tr>
            <td width="21" height="17">&nbsp;</td>
            <td width="248" align="left">
              <a href="define.php?id=<?php echo $array1['id'];?>"><?php echo $array1['books'];?></a></td>
          </tr>
            <?php
              }
              ?>
          ...
          <p align="right" ><a target="_blank" href="more.php?talk1=<?php echo $talk1;?>">更多&lt;&lt;</a></p></td>	
        <td align="center" valign="top" ><table width="281" height="44" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td height="19" colspan="2"><div align="center" class="STYLE3">C/C++</div></td>
          </tr>
		  <?php
          ...
          <tr>
            <td width="21" height="17">&nbsp;</td>
            <td width="248" align="left"><a href="define.php?id=<?php echo $array2['id'];?>"><?php echo $array2['books'];?></a></td>
          </tr>
		  <?php
		  }
		  ?>
        </table>
          <p align="right"><a target="_blank" href="more.php?talk1=<?php echo $talk2;?>">更多&lt;&lt;</a></p></td>
      </tr>
      <tr>
        <td height="99" align="center" valign="top"><table width="281" height="44" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td height="19" colspan="2"><div align="center" class="STYLE3">.net</div></td>
          </tr>
          <?php 
		  while($array3=mysqli_fetch_array($select3)){
		  $talk3=$array3['talk'];
		  ?>
		  <tr>
            <td width="21" height="17">&nbsp;</td>
            <td width="248" align="left"><a href="define.php?id=<?php echo $array3['id'];?>"><?php echo $array3['books'];?></a></td>
          </tr>
		  <?php
		  }
		  ?>
        </table>
          <p align="right"><a target="_blank" href="more.php?talk1=<?php echo $talk3;?>">更多&lt;&lt;</a></p></td>
        
        <td align="center" valign="top"><table width="281" height="44" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td height="19" colspan="2"><div align="center" class="STYLE3">JAVA</div></td>
          </tr>
		  <?php
		  while($array4=mysqli_fetch_array($select4)){
		  $talk4=$array4['talk'];
		  ?>
          <tr>
            <td width="21" height="17">&nbsp;</td>
            <td width="248" align="left"><a href="define.php?id=<?php echo $array4['id'];?>"><?php echo $array4['books'];?></a></td>
          </tr>
		  <?php
		  }
		  ?>
        </table>
          <p align="right"><a target="_blank" href="more.php?talk1=<?php echo $talk4;?>">更多&lt;&lt;</a></p></td>
      </tr>
      <tr>
        <td height="99" align="center" valign="top"><table width="281" height="44" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td height="19" colspan="2"><div align="center" class="STYLE3">VB</div></td>
          </tr>
		  <?php
		  while($array5=mysqli_fetch_array($select5)){
		  $talk5=$array5['talk'];
		  ?>
          <tr>
            <td width="21" height="17">&nbsp;</td>
            <td width="248" align="left"><a href="define.php?id=<?php echo $array5['id'];?>"><?php echo $array5['books'];?></a></td>
          </tr>
		  <?php
		  }
		  ?>
        </table>
          <p align="right"><a target="_blank" href="more.php?talk1=<?php echo $talk5;?>">更多&lt;&lt;</a></p></td>
        <td align="center" valign="top"><table width="281" height="44" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td height="19" colspan="2"><div align="center" class="STYLE3">其他</div></td>
          </tr>
		  <?php
		  while($array6=mysqli_fetch_array($select6)){
		  $talk6=$array6['talk'];
		  ?>
          <tr>
            <td width="21" height="17">&nbsp;</td>
            <td width="248" align="left"><a href="define.php?id=<?php echo $array6['id'];?>"><?php echo $array6['books'];?></a></td>
          </tr>
		  <?php
		  }
		  ?>
        </table>
          <p align="right"><a target="_blank" href="more.php?talk1=<?php echo $talk6;?>">更多&lt;&lt;</a></p></td>
      </tr>
    </table></td>
  </tr>
  <tr>
