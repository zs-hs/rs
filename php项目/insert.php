...
setInterval("labtime.innerText=new Date().toLocaleString()",1000)
  ...
  <tr>
    <td width="800" height="430" align="center" valign="middle"  background="images/6.jpg"><form action="insert_ok.php" method="post" enctype="multipart/form-data" name="form2" id="form2">
      <table width="527" height="321" border="0" cellpadding="0" cellspacing="0"><caption>图书信息管理</caption>
        <tr>
        ...
        <tr>
          ...
          <td><div align="left">
            <input name="sysnopsis" type="text" id="sysnopsis" size="50" />
          </div></td>
        </tr>
        <tr>
